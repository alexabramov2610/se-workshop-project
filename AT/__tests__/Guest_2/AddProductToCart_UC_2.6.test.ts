...
//         const {cart: {products}} = _serviceBridge.watchCart().data;
...
//         const productsBefore = _serviceBridge.watchCart().data.cart.products;
...
//     test("Valid insertion, adding with quantity", () => {
//         const quantity = 2;
//         const {data, error} = _serviceBridge.addToCart(_testStore1, _testProduct1, quantity);
//         expect(error).toBeUndefined();
//         expect(data).toBeDefined();
...
//     test("Valid insertion, adding with quantity and not enough items in store", () => {
//         const quantity = 20;
//         const {data, error} = _serviceBridge.addToCart(_testStore1, _testProduct1, quantity);
//         expect(data).toBeUndefined();
//         expect(error).toBeDefined();
